@include('admin.layouts.section.head')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <a class="nav-link" data-widget="pushmenu" href="#" role="button" style="display: inline-block"><i class="fas fa-bars"></i></a>
          <a style="margin-right: 15px" href="{{route('admin.index')}}">Home</a>
