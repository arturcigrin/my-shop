  <header id="header" class="u-header u-header-left-aligned-nav">
        <div class="u-header__section">
            <!-- Topbar -->
                @if(route('home'))@include('user.layouts.section.topbar') @endif
            <!-- End Topbar -->
            ...
            <div class="py-2 py-xl-5 bg-primary-down-lg">
                <div class="container my-0dot5 my-xl-0">
                    <div class="row align-items-center">
                                        ...
                                        <footer id="SVGwaveWithDots" class="svg-preloader u-header-sidebar__footer">
                                            ...
                                            <div class="position-absolute right-0 bottom-0 left-0 z-index-n1">
                                                <img class="js-svg-injector"
                                                    src="{{asset('front/svg/components/wave-bottom-with-dots.svg')}}"
                        ...
                        <!-- Search Bar -->
                       @include('user.layouts.section.search_bar')
                        <!-- End Search Bar -->
                        <!-- Header Icons -->
                                                    ...
                                                    <div class="">
                                                        <ul class="list-unstyled row mx-n2">
                                                            <li class="px-2 col-auto">
                                                                <img class="img-fluid"
                                                                    src="{{asset('public/front/img/75X75/img1.jpg')}}"
                                                ...
                                                <li class="border-bottom pb-3 mb-3">
                                                    <div class="">
                                                        <ul class="list-unstyled row mx-n2">
                                                            <li class="px-2 col-auto">
                                                                <img class="img-fluid"
                                                                    src="{{asset('front/img/75X75/img2.jpg')}}"
                                                                    alt="Image Description">
                                                            </li>
                                                            <li class="px-2 col">
                                                                <h5 class="text-blue font-size-14 font-weight-bold">
            ...
            <div class="d-none d-xl-block container">
                <div class="row">
                    <!-- Vertical Menu -->
                   @include('user.layouts.section.vertical_menu_home')
                    <!-- End Vertical Menu -->
                    <!-- Secondary Menu -->
                   @include('user.layouts.section.secondary_menu_home')
                    <!-- End Secondary Menu -->
                </div>
            </div>
